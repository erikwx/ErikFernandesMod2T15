...
class Dinosaur:
    def __init__(self):
        ...
        self.dino_duck = False # bool dino abaixando
        # VELOCIDADES
    ...
    def update(self, user_input):
        ...
        if user_input[pygame.K_UP] and not self.dino_jump: # se o input for UP, e ele nao tiver pulando
            ...
            self.dino_jump = False # jump vira false pra ele n poder pular
    ...
    def duck(self):
        ...
        self.step_index += 1 # adiciona +1 a cada passo para animação
